...
document.write('<link rel="stylesheet" href="http://static.smallpicture.com/concord-assets/fontawesome/4.1.0/css/font-awesome.min.css"/>');
document.write('<link rel="stylesheet" href="http://fargo.io/code/concord.css"/>');
...
(function($) {
	...
	$(document).on("keydown", function(event) {
		...
		if(!readonly){
			...
			switch (concordGetKeystroke (event)) {
				case "backspace":
					if (concord.mobile) {
